        ...
        <section class="book-exchange">
            <div class="book-exchange-header">
                ...
                <span class="book-exchange-search">
                    <input class="book-exchange-input" type="search" name="book-exchange-input" id="book-exchange-input" placeholder="Rechercher un livre">
                </span>
            </div>

            <div class="book-exchange-cards">
                <figure class="card">
